...
A simple monitoring system that will track & record soil moisture levels, air temperature, and received sunlight for your potted plants & windowsill gardens. 

This system uses [RaspberryPi](https://www.raspberrypi.org/products/), the Pimoroni [Enviro pHat] (https://learn.pimoroni.com/tutorial/sandyj/getting-started-with-enviro-phat), and SparkFun [Soil Moisture Sensor] (https://learn.sparkfun.com/tutorials/soil-moisture-sensor-hookup-guide).
